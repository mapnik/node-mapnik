...
var binding = require('bindings')('node-mapnik.node')
var binding_path = path.resolve(path.join(__dirname,'../package.json'));
var settings_path = path.join(path.dirname(__dirname),'lib/binding/mapnik_settings.js');
