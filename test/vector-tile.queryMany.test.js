...
test('vtile.queryMany bad parameters fails', (assert) => {
...
test('vtile.queryMany with out fields', (assert) => {
  var vtile = new mapnik.VectorTile(0,0,0);
  vtile.addGeoJSON(JSON.stringify(geojson),"layer-name");
...
test('vtile.queryMany async', (assert) => {
  var vtile = new mapnik.VectorTile(0,0,0);
  vtile.addGeoJSON(JSON.stringify(geojson),"layer-name");
...
test('vtile.queryMany concurrent x4', (assert) => {
  var remaining = 4;
  function run() {
    var vtile = new mapnik.VectorTile(0,0,0);
    vtile.addGeoJSON(JSON.stringify(geojson),"layer-name");
...
test('vtile.queryMany profile x10 runs', (assert) => {
  var remaining = 10;
  function run() {
    profile.queryMany([
