...
test('should return a feature if geo coords are used', (assert) => {
  var map = new mapnik.Map(256, 256);
  map.loadSync('./test/stylesheet.xml');
  map.zoomAll();
...
test('should return a feature if screen coords are used', (assert) => {
  var map = new mapnik.Map(256, 256);
  map.loadSync('./test/stylesheet.xml');
  map.zoomAll();
...
test('should return a failure as it is outside map area', (assert) => {
  var map = new mapnik.Map(256, 256);
  map.loadSync('./test/stylesheet.xml');
  map.zoomAll();
...
test('should return not return any features', (assert) => {
  var map = new mapnik.Map(256, 256);
...
test('should return a feature if screen coords are used - all layers', (assert) => {
  var map = new mapnik.Map(256, 256);
  map.loadSync('./test/stylesheet.xml');
  map.zoomAll();
  map.queryMapPoint(55, 130, {layer:0}, function(err, results) {
...
test('should return a feature if multiple layers are queried', (assert) => {
  var map = new mapnik.Map(256, 256);
  map.loadSync('./test/stylesheet.xml');
  map.zoomAll();
